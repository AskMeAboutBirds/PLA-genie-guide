...
def scan_group_id(group_id = 305,
                  ...
                  search_range=200,
                  gender = False, gs = -1, iv_filter_comparison = ['>=', '>=', '>=', '>=', '>=', '>='], shiny_filter=0, ):
...
def main(args):
    ...
    gs = int(args.gs)           # manual override for generator seed
...
if __name__ == '__main__':
    ...
    parser.add_argument("--gs", help="generator seed",
                        type=int, default=0)
